...
export function LoginCompany({ lang, onBack, onGoToRegister, onSuccess }) {
    ...
    <div className="shell">
      ...
      <div className="auth-header">
        ...
        <div className="role-badge">
          {Icons.building(G.green800)}
          {LANGS[lang].role.company.title}
        </div>
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 8 }}>
          <div className="field-group">
            ...
            <input
              ...
              type="text"
              placeholder={t.identifierPlaceholderCompany}
