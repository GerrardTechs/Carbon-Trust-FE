...
ownershipReject: "File rejected — must be PDF or image (JPG/PNG)",
  ...
  tr: {
    flag: "🇹🇷", label: "Türkçe",
    nav: { home: "Ana Sayfa", market: "Market", calc: "Hesapla", land: "Arazi", verify: "Doğrula", profile: "Profil", tx: "İşlemler" },
    dash: {
      ...
      alerts: "Uyarılar", dismiss: "Kapat",
      myProjects: "Aktif Projelerim", seeAll: "Tüm arazileri gör →",
    ...
    land: {
      title: "Arazi Yönetimi", addParcel: "Arazi Ekle",
    ...
    calc: {
      title: "Emisyon Hesaplayıcı", scope1: "Kapsam 1 — Doğrudan",
    ...
    tx: {
      ...
      blockchain: "Blockchain'de Görüntüle", confirmReceipt: "Alındığını Onayla",
      escrow: "Emanet Fonları (Escrow)", immutable: "47 düğüm tarafından doğrulandı · Değiştirilemez",
      ...
      blockchainNote: "Ethereum Testnet'te (Sepolia) kalıcı kayıt",
    },
    verify: { 
    ...
    profile: {
      ...
      wallet: "Blockchain Cüzdan ID", generate: "Cüzdan Oluştur",
      walletNote: "Cüzdan ID yalnızca bir kez oluşturulabilir ve kalıcı olarak saklanır.",
      walletImportant: "Önemli",
      walletFull: "Benzersiz blockchain Cüzdan ID'niz oluşturulacak ve veritabanımızda kalıcı olarak saklanacaktır. Bu daha sonra değiştirilemez.",
      walletGenerate: "✅ Cüzdan ID'mi Oluştur",
      walletStored: "✓ Kalıcı olarak saklandı · Tekrarlanamaz",
      esg: "ESG Puanı", esgStart: "ESG Değerlendirmesini Başlat",
      esgDesc: "Yapay zeka onaylı bir ESG puanı almak için anketi doldurun ve dosyaları gönderin.",
      esgStatus: { not_started: "Başlanmadı", in_progress: "Devam Ediyor", submitted: "Gönderildi", verified: "Doğrulandı" },
      esgVerified: "Yapay Zeka Tarafından Doğrulandı · 0–100 Ölçeği",
      esgAllAnswered: "Tüm sorular yanıtlandı!",
      esgSubmitDesc: "ESG puanınızı almak için yapay zeka analizine gönderin",
      esgCalculating: "Hesaplanıyor...",
      esgGenerate: "ESG Puanı Oluştur →",
      tree: "Sanal Ağaç 🌳", treeDesc: "İşlemlerle birlikte büyür",
      simulateTx: "Yeni İşlemi Simüle Et (+1 🌱)",
